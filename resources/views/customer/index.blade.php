									...
									<div class="payment-method  shop-cart-table">
										<div class="payment-accordion">
											...
											<div class="payment-content">
												...
												<a href="#"><img alt="" src="{{asset('frontend/assets/img/payment/1.png')}}"></a>
												<a href="#"><img alt="" src="{{asset('frontend/assets/img/payment/2.png')}}"></a>
												<a href="#"><img alt="" src="{{asset('frontend/assets/img/payment/3.png')}}"></a>
												<a href="#"><img alt="" src="{{asset('frontend/assets/img/payment/4.png')}}"></a>
											</div>
											<!-- Accordion end -->
